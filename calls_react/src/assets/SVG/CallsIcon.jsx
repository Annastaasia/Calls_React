export default function СallArrowIcon(props) {
  let arrowcolor = "";
  let arrowdirection = "";
  ...
  else if (props.in_out === 1 && props.status === "Не дозвонился") {
    arrowcolor = "#EA1A4F";
    arrowdirection = "rotate(180)";
  } //red dawn arrow
  else if (props.in_out === 0 && props.status === "Дозвонился") {
    arrowcolor = "#28A879";
  } //green up arrow
  else if (props.in_out === 0 && props.status === "Не дозвонился") {
    arrowcolor = "#EA1A4F";
  } //red up arrow
  else return <></>;
